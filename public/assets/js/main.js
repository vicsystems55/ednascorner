(function ($) {
  ...
  $documentOn.ready( function() {
    ...
    document.querySelectorAll('.circle-box').forEach(button => {
        button.addEventListener('mousemove', (e) => {
            ...
            button.style.transform = `translate(-50%, -50%) translate(${moveX}px, ${moveY}px)`;
        });
    ...
    if (typedEl) {
      new Typed(typedEl, {
        strings: [
          ...
          '<span class="highlight">Branding</span> Consultant',
          '<span class="highlight">Travel</span> Consultant',
          '<span class="highlight">Entrepreneur</span>',
          '<span class="highlight">Fashion</span> Designer',
        ],
        typeSpeed: 200,
        backSpeed: 100,
        startDelay: 0,
